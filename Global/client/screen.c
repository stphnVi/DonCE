...
void runGame(SDL_Renderer *renderer)
{
    ...
    while (!quit)
    {
        ...
        sprintf(&str1, "posJugador:[%d,%d]-posCocodrilos:[[%d,%d]]\n", characterTileX, characterTileY,characterTileX,characterTileY);
        writeToServer(str1);
        ...
        //_________________________________________________/  Dibujar frutas  
        
        setDynamicTile(&tilemapDynamic, renderer, readFromServer());
